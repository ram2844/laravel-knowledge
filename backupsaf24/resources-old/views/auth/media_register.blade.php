...
<section class="saf-registerpage">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <h1 class="main-title">Media Registration Form</h1>
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <form class="registerfrm" action="{{ route('media.register', request()->query()) }}" method="POST" autocomplete="on" onsubmit="return submitRegistrationForm(this)">
                    @csrf
