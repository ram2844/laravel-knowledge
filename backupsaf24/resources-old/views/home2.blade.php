    ...
    <div class="container">
        ...
        <div class="row highlighrow">
            <div class="col-md-7">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 pb-5">
                        <div class="filter-date">
                            @if($event_dates)
                                ...
                                @if($dayNo > 1)
                                    <a href="{{ route('home', ['day' => ($dayNo - 1)]) }}#highlightsSection">⟵</a>
                                @else
                                    <a href="javascript:void(0)">⟵</a>
                                @endif

                                <p>DAY {{ $dayNo }}, {{ @date('d M', strtotime($event_dates[$dayNo-1])) }}</p>

                                @if($dayNo < count($event_dates))
                                    <a href="{{ route('home', ['day' => ($dayNo + 1)]) }}#highlightsSection">⟶</a>
                                @else
                                    <a href="javascript:void(0)">⟶</a>
                                @endif
                    ...
                    <!-- <div class="col-md-6 pb-5">
                        <form>
                            <select name="filter-highlight" class="form-control">
            ...
            <div class="col-md-5">
                ...
                @php $p = (int) request()->get('p', 0); @endphp
                ...
                @if($programs && isset($programs[$p]))
                    ...
                    <div class="featured-highlight ">
                        ...
                        <img src="{{url('uploads/programs/thumbnails/250').'/'.$singleProgram->program_image}}" class="{{ $singleProgram->name }}">
...
<script type="text/javascript">
    ...
    function getHighlights(type = null){
        ...
        $.ajax({
            type: "GET",
            url: "{{ url('highlights') }}?day="+day+"&venue_id="+venue_id,
            dataType: 'json',
