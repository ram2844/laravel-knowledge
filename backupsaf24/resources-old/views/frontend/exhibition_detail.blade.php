    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="modal safevbk fade" id="bookSeatModal99999" tabindex="-1" role="dialog" aria-labelledby="bookSeatModalLabel99999" aria-hidden="true">
                ...
                <div class="programrightblock">
                    ...
                    @if($programVenues->count())
                        ...
                        <div class="icon" style="position: relative;">
    						...
    						<i class="fa fa-share" aria-hidden="true" style="cursor:pointer;" onclick="copyTextToClipboard(this, '{{ url()->full() }}')"></i>
        ...
        @if($programs->count())
            <div class="row pt-5 pb-5">
                <div class="col-md-12">
                    <h3 class="related-program">Related exhibitions</h3>
                </div>
            </div>
