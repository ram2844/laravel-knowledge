...
<section class="intro-section">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h1 class="title">India's largest <span>multidisciplinary arts festival</span> is back for its 8<sup>th</sup> edition.</h1>
            </div>
        </div>
        <div class="row pb-5">
            <div class="col-md-6">
...
<section class="browseprogram-section d-none-">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="exhibition-gallery----">
                                        <div class="owl-carousel owl-theme owl-carousel-exhibitions">
                                            @foreach($programs as $key2 => $value2)
                                                <div class="single-item">
                                                    <a href="{{ route('exhibition.details', ['id' => $value2->slug]) }}" target="_blank">
                    ...
                    @if($programs->count())
                        <div class="panel" id="two-panel">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="exhibition-gallery----">
                                        <div class="owl-carousel owl-theme owl-carousel-performances">
                                            @foreach($programs as $key2 => $value2)
                                                <div class="single-item">
                                                    <a href="{{ route('program.details', ['id' => $value2->slug]) }}" target="_blank">
                                                        <img src="{{ url('uploads/programs').'/'.$value2->program_image}}" class="pgrimg">
                                                    </a>
                                                </div>
                    ...
                    @if($programs->count())
                        <div class="panel" id="three-panel">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="exhibition-gallery----">
                                        <div class="owl-carousel owl-theme owl-carousel-workshops">
                                            @foreach($programs as $key2 => $value2)
                                                <div class="single-item">
                                                    <a href="{{ route('program.details', ['id' => $value2->slug]) }}" target="_blank">
                                                        <img src="{{ url('uploads/programs').'/'.$value2->program_image}}" class="pgrimg">
                    ...
                    @if($programs->count())
                        <div class="panel" id="four-panel">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="exhibition-gallery----">
                                        <div class="owl-carousel owl-theme owl-carousel-talks">
                                            @foreach($programs as $key2 => $value2)
                                                <div class="single-item">
                                                    <a href="{{ route('program.details', ['id' => $value2->slug]) }}" target="_blank">
                                                        <img src="{{ url('uploads/programs').'/'.$value2->program_image}}" class="pgrimg">
                    ...
                    @if($programs->count())
                        <div class="panel" id="five-panel">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="exhibition-gallery----">
                                        <div class="owl-carousel owl-theme owl-carousel-other-programmes">
                                            @foreach($programs as $key2 => $value2)
                                                <div class="single-item">
                                                    <a href="{{ route('program.details', ['id' => $value2->slug]) }}" target="_blank">
                                                        <img src="{{ url('uploads/programs').'/'.$value2->program_image}}" class="pgrimg">
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="book-seat">
                   ...
                   <a class="bookseat-link" href="/programs">book seats ⟶</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $('.owl-carousel-exhibitions').owlCarousel({
            stagePadding: window.screen.width/5,
            margin: 10,
            nav: true,
            loop: true,
            autoplay: true,
        ...
        let html = $(".owl-carousel-exhibitions .owl-nav-custom");
        // $(".owl-nav-custom").remove();
        $(".owl-carousel-exhibitions .owl-dots-custom-wrapper").append(html);
    });

    $(document).ready(function() {
        $('.owl-carousel-performances').owlCarousel({
            stagePadding: window.screen.width/5,
            margin: 10,
            nav: true,
            loop: true,
        ...
        let html = $(".owl-carousel-performances .owl-nav-custom");
        // $(".owl-nav-custom").remove();
        $(".owl-carousel-performances .owl-dots-custom-wrapper").append(html);
    });

    $(document).ready(function() {
        $('.owl-carousel-workshops').owlCarousel({
            stagePadding: window.screen.width/5,
            margin: 10,
            nav: true,
            loop: true,
        ...
        let html = $(".owl-carousel-workshops .owl-nav-custom");
        // $(".owl-nav-custom").remove();
        $(".owl-carousel-workshops .owl-dots-custom-wrapper").append(html);
    });

    $(document).ready(function() {
        $('.owl-carousel-talks').owlCarousel({
            stagePadding: window.screen.width/5,
            margin: 10,
            nav: true,
            loop: true,
        ...
        let html = $(".owl-carousel-talks .owl-nav-custom");
        // $(".owl-nav-custom").remove();
        $(".owl-carousel-talks .owl-dots-custom-wrapper").append(html);
    });

    $(document).ready(function() {
        $('.owl-carousel-other-programmes').owlCarousel({
            stagePadding: window.screen.width/5,
            margin: 10,
            nav: true,
            loop: true,
        ...
        let html = $(".owl-carousel-other-programmes .owl-nav-custom");
        // $(".owl-nav-custom").remove();
        $(".owl-carousel-other-programmes .owl-dots-custom-wrapper").append(html);
    });
