<li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
    <a href="javascript:;" class="menu-link menu-toggle">
        ...
        <span class="menu-text">Media Booking</span>
        ...
        <ul class="menu-subnav">
            ...
            @if(
            	...
            	<li class="menu-item" aria-haspopup="true">
	                <a href="{{route('admin.media_slot.index')}}" class="menu-link">
	                    <i class="menu-bullet menu-bullet-dot">
	                        <span></span>
	                    </i>
	                    <span class="menu-text">List Media Slots</span>
	                </a>
	            </li>
            @endif
            ...
            @if(
	            ...
	            <li class="menu-item" aria-haspopup="true">
	                <a href="{{route('admin.media_booking.index', ['type' => 'completed'])}}" class="menu-link">
	                    <i class="menu-bullet menu-bullet-dot">
	                        <span></span>
	                    </i>
	                    <span class="menu-text">Media Booking</span>
