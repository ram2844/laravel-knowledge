							...
							<div class="dropdown dropdown-inline mr-2">
                                ...
                                <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                    ...
                                    <ul class="navi flex-column navi-hover py-2">
                                        ...
                                        <li class="navi-item">
                                            <a href="{{ route($moduleConfig['routes']['listRoute'], ['type' => 'confirm']) }}" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="la la-print"></i>
                                                </span>
                                                <span class="navi-text">Confirmed</span>
                                            </a>
                                        </li>
                                        <li class="navi-item">
                                            <a href="{{ route($moduleConfig['routes']['listRoute'], ['type' => 'processing']) }}" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="la la-copy"></i>
                                                </span>
                                                <span class="navi-text">Processing</span>
                                            </a>
                                        </li>

                                        <li class="navi-item">
                                            <a href="{{ route($moduleConfig['routes']['listRoute'], ['type' => 'completed']) }}" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="la la-copy"></i>
                                                </span>
                                        ...
                                        <li class="navi-item">
                                            <a href="{{ route($moduleConfig['routes']['listRoute'], ['type' => 'Cancel']) }}" class="navi-link">
                                                <span class="navi-icon">
                                                    <i class="la la-copy"></i>
                                                </span>
                                                <span class="navi-text">Cancelled</span>
                                            </a>
                                        </li>
                                    </ul>
                                    <!--end::Navigation-->
