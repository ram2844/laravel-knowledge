    ...
    jQuery(document).ready((function() {
		...
		var columnsArray 	=	[
            ...
            },
            {
                ...
                title: "Image",
                template: function(t) {
                    return ( typeof t?.featured_image != 'undefined' && t?.featured_image)? '<img src="'+__BASE_URL_JS__+"uploads/medias/thumbnails/250/"+t?.featured_image+'" style="height:50px" />' : 'N/A';
                }
            },
            {
                field: "title",
