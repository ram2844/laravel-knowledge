                    ...
                    <div class="col-9">
                        ...
                        <div class="form-group row validated">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <select class="form-control selectpicker" name="person_id" tabindex="null" required>
                                    <option value="">Select</option>
                                    @if($meetingPersons->count())
                                        @foreach($meetingPersons as $value)
                                           <option {{ old('person_id', $row->person_id ?? '') == $value->id ? 'selected' : ''  }} value="{{$value->id}}">{{$value->name}}</option>
                                        @endforeach
                                    @endif
                                </select>
