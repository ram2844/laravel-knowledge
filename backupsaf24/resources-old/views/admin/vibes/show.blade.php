		                ...
		                <div class="row">
		                    ...
		                    <div class="col-6">
		                        ...
		                        <div class="form-group row validated">
		                            ...
		                            <div class="col-lg-9 col-md-9 col-sm-12">
		                            	<label class="col-form-label text-lg-right">{{$row->short_description}}</label>
		                        ...
		                        <div class="form-group row validated">
		                            ...
		                            <div class="col-lg-9 col-md-9 col-sm-12">
		                            	...
		                            	<label class="col-form-label text-lg-right">{{$row->external_link}}</label>
		                        ...
		                        <div class="form-group row validated">
		                            ...
		                            <div class="col-lg-9 col-md-9 col-sm-12">
		                            	...
		                            	<label class="col-form-label text-lg-right">{{$row->partnerType->name ?? 'N/A'}}</label>
		                            ...
		                            <div class="col-lg-9 col-md-9 col-sm-12">
		                            	...
		                            	<div class="image-input image-input-outline" id="featured_image_1" style="background-image: url({{asset('media/users/blank.png')}})">
		                            		...
		                            		@if(isset($row->featured_image) && !empty($row->featured_image))
												<div class="image-input-wrapper" style="background-image: url({{asset('uploads/vibes/'.$row->featured_image)}})"></div>
		                            		@else
