    ...
    jQuery(document).ready((function() {
		...
		var columnsArray 	=	[
            ...
            },
            {
                ...
                template: function(t) {
                    return ( typeof t?.featured_image != 'undefined' && t?.featured_image)? '<img src="'+__BASE_URL_JS__+"uploads/vibes/thumbnails/250/"+t?.featured_image+'" style="height:50px" />' : 'N/A';
                }
            },	
            {
                field: "title",
            ...
            }, 
            {
                ...
                title: "Type",
                template: function(t) {
                    return ( typeof t?.partner_type?.name != 'undefined' && t?.partner_type?.name)? t?.partner_type?.name : 'N/A';
                }
            },	
            {
                field: "status",
