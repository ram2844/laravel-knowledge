            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-9">
                        ...
                        <div class="form-group row validated">
                            <label class="col-form-label col-lg-3 col-sm-12 text-lg-right">External Link </label>
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <input type="text" name="external_link" value="{{ old('external_link') ? old('external_link') : ( isset($row->external_link) ? $row->external_link : '') }}" class="form-control" {{isset($row->external_link) ? '':'required'}} placeholder="Enter External Link" autocomplete="new external_link" />
                                @error('external_link')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                        ...
                        <div class="form-group row validated">
                            <label class="col-form-label col-lg-3 col-sm-12 text-lg-right"> Vibe Type </label>
                            <div class="col-lg-9 col-md-9 col-sm-12">
                                <select class="form-control selectpicker" name="partner_type_id" tabindex="null" required>
                                    <option value="" data-slug="">Select</option>
                                    @if($partnerTypes->count())
                                        @foreach($partnerTypes as $value)

                                           <option {{ !empty(old('partner_type_id')) && old('partner_type_id') == $value->id ? 'selected' : ( isset($row->partner_type_id) && $row->partner_type_id == $value->id ? 'selected' : '' ) }} value="{{$value->id}}">{{$value->name}}</option>
