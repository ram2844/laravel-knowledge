    ...
    jQuery(document).ready((function() {
		...
		var columnsArray 	=	[
            ...
            },
            {
                ...
                title: "program image",
                template: function(t) {
                    return ( typeof t?.program_image != 'undefined' && t?.program_image)? '<img src="'+__BASE_URL_JS__+"uploads/programs/thumbnails/250/"+t?.program_image+'" style="height:50px" />' : 'N/A';
                }
            },	
            {
                field: "name",
            ...
            }, 
            {
                ...
                title: "discipline",
                template: function(t) {
                    return ( typeof t?.discipline?.name != 'undefined' && t?.discipline?.name)? t?.discipline?.name : 'N/A';
                }
            },
            {
                field: "amount",
