							...
							<div class="row">
								...
								<div class="col-md-2">
									<a href="javascript:void(0)" class="btn btn-primary search_bttn">
										<!-- <i class="flaticon-search-magnifier-interface-symbol icon-md"></i> Search -->
										<i class="flaticon2-search-1"></i> Search
									</a>
									<button class="btn btn-default refresh_all">
										<i class="flaticon-refresh text-danger pr-0"></i>
									</button>
								</div>
    ...
    jQuery(document).ready((function() {
		...
		var columnsArray 	=	[
            ...
            },
            {
                ...
                title: "logo",
                template: function(t) {
                    return ( typeof t?.logo != 'undefined' && t?.logo)? '<img src="'+__BASE_URL_JS__+"uploads/sponsors/thumbnails/250/"+t?.logo+'" style="height:50px" />' : 'N/A';
                }
            },
            {
                field: "name",
            ...
            }, 
            {
                ...
                title: "Sponsor Type",
                template: function(t) {
                    return ( typeof t?.sponsor_type?.name != 'undefined' && t?.sponsor_type?.name)? t?.sponsor_type?.name : 'N/A';
                }
            }, 
            {
                field: "status",
