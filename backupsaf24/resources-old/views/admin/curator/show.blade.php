		            ...
		            <div class="card-body">
		                <div class="row">
		                    ...
		                    <div class="col-6">
		                        ...
		                        <div class="form-group row validated">
		                            <label class="col-form-label col-lg-3 col-sm-12 text-lg-right">Bio: </label>
		                            <div class="col-lg-9 col-md-9 col-sm-12">
		                            	<label class="col-form-label text-lg-right">{!!$row->bio!!}</label>
		                        ...
		                        <div class="form-group row validated">
		                            ...
		                            <div class="col-lg-9 col-md-9 col-sm-12">
		                            	...
		                            	<label class="col-form-label text-lg-right">{{ isset($row->discipline->name) ? $row->discipline->name : 'N/A' }}</label>
